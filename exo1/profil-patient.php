...
$patientsQueryStat->bindValue(':idPatient', $idPatient, PDO::PARAM_INT);
try {
...
?>
   <div class="container text-center">
      ...
      <table class="table table-bordered text-black">
        ...
        <tbody>
          <tr>
            <?php foreach ($patientsInfos AS $patientsInfo): ?>
             <td><?= $patientsInfo ?></td>
            <?php endforeach; ?>
          </tr>
      </tbody>
    ...
    <a class="btn btn-light" href="liste-patient.php">Liste des patients</a>
  </div>
<?php
include '../footer.php';
?>